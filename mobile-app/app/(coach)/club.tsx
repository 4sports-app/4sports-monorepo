...
export default function ClubInfoScreen() {
  ...
  const logoUri = clubInfo?.logo || clubInfo?.logoUrl;
    ...
    <Card key={person._id} style={styles.personCard}>
      <Card.Content style={styles.personContent}>
        <View style={styles.personHeader}>
          ...
          {person._id !== user?._id && (
            <TouchableOpacity style={styles.chatIconButton} onPress={() => handleChatWithUser(person._id)}>
...
const styles = StyleSheet.create({
  ...
  chatIconButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: Colors.primary + '15', justifyContent: 'center', alignItems: 'center' },
});
