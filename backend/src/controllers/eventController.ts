...
export const createEvent = async (req: Request, res: Response) => {
  try {
    ...
    const { groupId, title, description, type, color, startTime, endTime, location, locationCoords, isMandatory, notes, equipment, maxParticipants, isRecurring, recurringPattern } = req.body;
...
export const updateEvent = async (req: Request, res: Response) => {
  try {
    ...
    const { id } = req.params;
    const { title, description, type, color, startTime, endTime, location, locationCoords, isMandatory, status, notes, equipment, maxParticipants } = req.body;
